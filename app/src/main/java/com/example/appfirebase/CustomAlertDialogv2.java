...
public class CustomAlertDialogv2 extends DialogFragment {
    ...
    public CustomAlertDialogv2(String title, String message, String msg_btn_positive, String msg_btn_negative,
